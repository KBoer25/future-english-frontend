...
export default function Home() {
  ...
  // FULLY CUSTOMIZED, UNIQUE, LEVEL-APPROPRIATE QUIZ GENERATOR FOR EVERY LEVEL & BATCH (1 TO 5)
        ...
        // 2. PRIMARY SCHOOL
          ...
          if (top === "Daily Life") {
            ...
            const pools = [
              ...
              [
                { id: 1, prompt: "What is netiquette?", img: "💻", opts: [{ l: "Polite and respectful manners when communicating online", c: true }, { l: "Internet cable wire", c: false }], explanation: "Online manners." },
                { id: 2, prompt: "What should you do if you receive a mean text message from a schoolmate?", img: "📵", opts: [{ l: "Save the message and show a trusted adult", c: true }, { l: "Reply with meaner insults", c: false }], explanation: "Evidence and adults." },
                { id: 3, prompt: "Why is it unsafe to meet someone in person whom you only met in an online game?", img: "⚠️", opts: [{ l: "Online strangers may not be who they pretend to be", c: true }, { l: "They might bring you a cake", c: false }], explanation: "Stranger safety." },
                { id: 4, prompt: "What does it mean to respect someone's privacy online?", img: "🔒", opts: [{ l: "Not sharing their private photos or chats without permission", c: true }, { l: "Posting their secrets", c: false }], explanation: "Privacy respect." },
              ...
              [
                { id: 1, prompt: "What is spam in email or messaging inboxes?", img: "🗑️", opts: [{ l: "Unwanted junk messages sent to many people at once", c: true }, { l: "Important homework from teachers", c: false }], explanation: "Junk messages." },
