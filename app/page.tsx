...
export default function Home() {
  ...
  // Track which flashcards are flipped (Card ID + Subtopic Index)
  ...
  // FULLY POPULATED STUDY MATERIALS DATABASE
        ...
        <div className="max-w-3xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-200">
          ...
          <div className="space-y-8">
            {currentStudyGuide.subTopics.map((sub, idx) => {
              const cardKey = `${currentStudyGuide.id}-${idx}`;
              ...
              return (
                <div
                  ...
                  className="cursor-pointer perspective-1000 min-h-[260px] transition transform hover:scale-[1.01]"
                >
                  <div
                    className={`relative w-full rounded-3xl border-2 transition-all duration-500 shadow-md p-8 bg-white flex flex-col justify-between ${
                  ...
                  >
                    {!isFlipped ? (
                      ...
                      // BACK OF FLASHCARD (EXPLANATIONS & EXAMPLES)
  ...
  return (
    <main className="min-h-screen bg-[#FAFAFA] text-gray-800 font-sans p-8 relative">
      ...
      {/* TAB 2: STUDY MATERIALS (Interactive 3D Flashcard Mode) */}
      {activeTab === "materials" && (
