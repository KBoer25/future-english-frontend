...
export default function Home() {
      ...
      for (let i = 1; i <= 5; i++) {
        ...
        list[key] = {
          ...
          questions: [
            {
              id: 1,
              prompt: `[${selectedLevel} | ${top}] Question 1: Which core principle best describes effective communication in this scenario?`,
              imageIllustration: "🌟📘💡",
              options: [
            ...
            {
              id: 2,
              prompt: `[${selectedLevel} | ${top}] Question 2: What is the most appropriate action when executing this task?`,
              imageIllustration: "🎯📝✨",
              options: [
            ...
            {
              id: 3,
              prompt: `[${selectedLevel} | ${top}] Question 3: Identify the correct grammatical or structural pattern:`,
              imageIllustration: "📚🔍💬",
              options: [
            ...
            {
              id: 4,
              prompt: `[${selectedLevel} | ${top}] Question 4: What is the primary objective of mastering this skill?`,
              imageIllustration: "🏆📈⭐",
              options: [
            ...
            {
              id: 5,
              prompt: `[${selectedLevel} | ${top}] Question 5: Evaluate the outcome of proper implementation:`,
              imageIllustration: "✅🎉👏",
              options: [
  ...
  // FULLY POPULATED STUDY MATERIALS DATABASE COVERING EVERY SINGLE LEVEL AND CATEGORY
    ...
    <main className="min-h-screen bg-[#FAFAFA] text-gray-800 font-sans p-8 relative">
      ...
      <section className="max-w-4xl mx-auto text-center my-10">
        ...
        <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
          Choose your school level and topic category below to explore fully verified, detailed study guides and interactive quiz batches.
        </p>
      ...
      {/* TAB 2: STUDY MATERIALS (Fully Stocked & Mapped for the selected Level and Category) */}
      {activeTab === "materials" && (
        <section className="max-w-4xl mx-auto space-y-6">
          {(() => {
            // Find an exact match for the selected level and topic, or generate a rich verified fallback guide if missing
            const matchedGuide = studyGuides.find(g => g.level === selectedLevel && g.category === selectedTopic) || {
              ...
              summary: `Comprehensive academic and practical guide for ${selectedLevel} students focusing on ${selectedTopic}, built upon certified curriculum standards.`,
